<x-app-layout>
    ...
    <section class="relative min-h-screen" data-aos="fade-in" id="home">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
            <div class="absolute w-96 h-96 bg-yellow-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
            <div class="absolute w-96 h-96 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>

        <!-- Hero Content -->
        <div class="relative min-h-screen flex items-center justify-center px-4">
            <div class="text-center space-y-8">
                <h1 class="text-6xl md:text-7xl font-bold text-white leading-tight" data-aos="zoom-in">
                    SOUNDWAVE<br/>FEST 2025
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="400">
                    @auth
                        <a href="{{ route('tickets.index') }}" class="px-8 py-4 bg-white bg-opacity-20 backdrop-blur-lg rounded-full text-white font-semibold hover:bg-opacity-30 transition-all duration-300 border border-white/30">
                            Get Your Tickets 🎟️
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="px-8 py-4 bg-white bg-opacity-20 backdrop-blur-lg rounded-full text-white font-semibold hover:bg-opacity-30 transition-all duration-300 border border-white/30">
        ...
        <div x-data="countdown" x-init="init()" 
             class="absolute top-24 right-6 bg-white/10 backdrop-blur-md rounded-2xl p-6 text-white border border-white/20"
             data-aos="fade-left">
            <div class="grid grid-cols-4 gap-4 text-center">
                <div>
                    <span x-text="days || '0'" class="block text-2xl font-bold"></span>
                    <span class="text-xs uppercase tracking-wide">Days</span>
                </div>
                <div>
                    <span x-text="hours || '0'" class="block text-2xl font-bold"></span>
                    <span class="text-xs uppercase tracking-wide">Hours</span>
                </div>
                <div>
                    <span x-text="minutes || '0'" class="block text-2xl font-bold"></span>
                    <span class="text-xs uppercase tracking-wide">Mins</span>
                </div>
                <div>
                    <span x-text="seconds || '0'" class="block text-2xl font-bold"></span>
                    <span class="text-xs uppercase tracking-wide">Secs</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="lineup" class="py-20 bg-gradient-to-b from-black to-purple-900 scroll-mt-16">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-4xl font-bold text-center text-white mb-12" data-aos="fade-up">Featured Artists 🌟</h2>
    ...
    <section id="events" class="py-20 bg-gradient-to-b from-purple-900 to-black scroll-mt-16">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-4xl font-bold text-center text-white mb-12" data-aos="fade-up">Upcoming Events 🎫</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($upcomingEvents as $event)
                    <div class="group" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 + 100 }}">
                        <a href="{{ route('events.show', $event) }}" class="block">
                            <div class="relative p-8 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 transition-all duration-300">
    ...
    <section id="tickets" class="py-20 bg-black scroll-mt-16">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-4xl font-bold text-center text-white mb-12" data-aos="fade-up">Get Your Tickets 🎫</h2>
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20" data-aos="fade-up">
                <div class="text-center space-y-4">
                    <h3 class="text-2xl font-bold text-white">Ready to experience amazing events?</h3>
                    <p class="text-white/80">Browse our ticket collection and find the right one for you!</p>
                    @auth
                        <a href="{{ route('tickets.index') }}" 
                           class="inline-block px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full font-semibold hover:opacity-90 transition-opacity">
                            Browse All Tickets
                        </a>
                    @else
                        <a href="{{ route('login') }}" 
    ...
    <section id="faq" class="py-20 bg-gradient-to-b from-black to-purple-900 scroll-mt-16">
        <div class="max-w-4xl mx-auto px-4">
            <h2 class="text-4xl font-bold text-center text-white mb-12" data-aos="fade-up">FAQ ❓</h2>
    ...
    <!-- Footer -->
    <footer class="py-8 bg-black text-center" data-aos="fade-up">
        <div class="max-w-4xl mx-auto px-4">
            <div class="flex justify-center space-x-6 mb-6">
                <a href="https://instagram.com" target="_blank" class="text-white/80 hover:text-white transition-colors">
                ...
                <a href="https://twitter.com" target="_blank" class="text-white/80 hover:text-white transition-colors">
                    <span class="sr-only">Twitter</span>
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                    </svg>
                </a>
                <a href="https://tiktok.com" target="_blank" class="text-white/80 hover:text-white transition-colors">
