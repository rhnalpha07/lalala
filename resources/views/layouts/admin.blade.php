    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 overflow-y-auto">
            ...
            <nav class="mt-5">
                ...
                <a href="{{ route('admin.events.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                    Events
                </a>
                <a href="{{ route('admin.artists.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
