                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="flex space-x-4">
                                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('events.show', ['event' => $event->id])) }}" 
                                               target="_blank" 
                                            ...
                                            <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('events.show', ['event' => $event->id])) }}&text={{ urlencode($event->name) }}" 
                                               target="_blank" 
                                            ...
                                            <a href="https://wa.me/?text={{ urlencode($event->name . ' - ' . route('events.show', ['event' => $event->id])) }}" 
                                               target="_blank" 
